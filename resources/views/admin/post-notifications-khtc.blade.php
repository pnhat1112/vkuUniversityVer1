				...
				<div class="row">
					<div class="col-md-12">
						<div class="card card-transparent">
							...
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="update-notice/{{$edit->id}}" enctype="multipart/form-data">
										...
										<h4>Nội dung:</h4>
										<textarea id="mytextarea" name="mytextarea" style="height: 500px;">{{$edit->content}}</textarea></br></br>
										<a href='{{ asset("$edit->filePath") }} '><?php echo $edit->fileName ?></a>
										<h4>File đính kèm:</h4><input type="file" name="file"></br>
										<input type="submit" name="update-thong-bao" value="Sửa thông báo" class="btn-danger btn-submit">
									</form>
								</div>
							</div>
							@else
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="upload-notifications-khtc" enctype="multipart/form-data">
										{{csrf_field()}}
										@if ($message = Session::get('success'))
										<div class="alert alert-success">
											<strong>{{ $message }}</strong>
