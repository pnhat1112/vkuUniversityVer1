						...
						<div class="card card-transparent">
							...
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="update-event/{{$edit->id}}" enctype="multipart/form-data">
										{{csrf_field()}}
										...
										@endif
										<h4>Tên sự kiện:</h4><input type="text" name="nameEvent" style="width: 100%; height: 50px; font-size: 20px;" value="{{$edit->nameEvent}}"></br>
										<h4>Thời gian:</h4><input type="date" name="time" style="width: 100%; height: 50px; font-size: 20px;" value="{{$edit->time}}"></br></br></br>

										<input type="submit" name="update-event" value="Sửa sự kiện" class="btn-danger btn-submit">
									</form>
								</div>
							</div>
							...
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="upload-event" enctype="multipart/form-data">
										{{csrf_field()}}
										@if ($message = Session::get('success'))
										<div class="alert alert-success">
											<strong>{{ $message }}</strong>
										...
										@endif
										<h4>Tên sự kiện:</h4><input type="text" name="nameEvent" style="width: 100%; height: 50px; font-size: 20px;"></br>
										<h4>Thời gian:</h4><input type="date" name="time" style="width: 100%; height: 50px; font-size: 20px;"></br></br></br>

										<input type="submit" name="upload-event" value="Đăng sự kiện" class="btn-danger btn-submit">
									</form>
								</div>
							</div>
							@endif
