              ...
              <div class="card-body">
                <div class="col-md-10 ml-auto mr-auto">
                  <div class="content" style=" overflow-x: scroll;">
                    <form>
                      <div class="form-group" method="get" action="{{route('gv.tkb')}}">
                        @csrf
                        <label for="exampleInputEmail1">Nhập email giảng viên</label>
                        <input type="text" class="form-control" name="giangvien">
                        <div class="text-right">
                          <button type="submit" class="btn btn-primary" style="margin-top: 20px;">Xem</button>
                        </div>
                      </div>
                    </form>
  ...
  $(document).ready(function() {
    $(".gv").on({
      mouseenter: function() {
          ...
          //   $("#gvList").css("visibility", "hidden");
          // });
          $("#gvList").css("visibility", "visible");
          $("#gvList li").on("click", function() {
            var data = $(this).attr('value');
            $("#gvInput").val(data);
            $("#gvList").css("visibility", "hidden");
          });
          $("#gcInput").on("keyup", function() {
            var value = $(this).val().toLowerCase();
            $("#gvList li").filter(function() {
    ...
    $(".sv").on({
      mouseenter: function() {
          ...
          //   $("#gvList").css("visibility", "hidden");
          // });
          $("#svList").css("visibility", "visible");
          $("#svList li").on("click", function() {
            var data = $(this).attr('value');
            $("#svInput").val(data);
            $("#svList").css("visibility", "hidden");
          });
          $("#svInput").on("keyup", function() {
            var value = $(this).val().toLowerCase();
            $("#svList li").filter(function() {
              $(this).toggle($(this).attr('id').toLowerCase().indexOf(value) > -1)
              // $(this).toggle($(this).attr('value').toLowerCase().indexOf(value) > -1)
            });
          });
