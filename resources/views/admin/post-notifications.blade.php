									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted">{{Auth::user()->name}}</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
											</div>
										</div>
									</li>
									<li>
						...
						<div class="card card-transparent">
							...
							@if(isset($edit))
								...
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="update-notice/{{$edit->id}}" enctype="multipart/form-data">
										{{csrf_field()}}
										...
										@endif
										<h4>Tiêu đề:</h4><input type="text" name="title" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" style="width: 100%; height: 50px; font-size: 20px;" value="{{$edit->title}}"></br>
										<h4>Slug:</h4><input type="text" id="slug" name="slug" style="width: 100%; height: 50px; font-size: 20px;" value="{{$edit->slug}}"></br>
										<h4>Nội dung:</h4>
										<textarea id="txtEditContent" name="txtEditContent" style="height: 500px;">{{$edit->content}}</textarea></br>
										<a href='{{ asset("$edit->filePath") }} '><?php echo $edit->fileName ?></a>
										<h4>File đính kèm:</h4><input type="file" name="file"></br>
										<input type="submit" name="update-notice" value="Sửa thông báo" class="btn-danger btn-submit">
									</form>
								</div>
							</div>
							...
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="upload-thong-bao" enctype="multipart/form-data">
										{{csrf_field()}}
										@if ($message = Session::get('success'))
										<div class="alert alert-success">
											<strong>{{ $message }}</strong>
										...
										@endif
										<h4>Tiêu đề:</h4><input type="text" name="title" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" style="width: 100%; height: 50px; font-size: 20px;"></br>
										<h4>Slug:</h4><input type="text" id="slug" name="slug" style="width: 100%; height: 50px; font-size: 20px;"></br>
										<h4>Nội dung:</h4>
										<textarea id="mytextarea" name="mytextarea" style="height: 500px;"></textarea></br>
										<h4>File đính kèm:</h4><input type="file" name="file"></br>
