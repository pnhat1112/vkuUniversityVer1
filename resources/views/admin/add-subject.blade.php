...
<body>
            ...
            <div class="card card-transparent">
              ...
              <div class="card-body">
                <div class="col-md-10 ml-auto mr-auto">
                  ...
                  <!-- <div class="container-fluid"> -->
                    <!-- Modal -->
                    <form method="POST" action="{{route('add-subject.add')}}">
                      @csrf
                      <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Thêm môn học vào TKB</h5>
                            ...
                            <div class="modal-body">
                              <div class="form-group">
                                <label>Môn học</label>
                                <input type="text" id="monInput" class="form-control mon" autocomplete="off" name="mon">
                                <ul class="list-group" id="monList">
                                  <!-- <li class="list-group-item" value="Toán rời rạc 3">Toán rời rạc 3</li> -->
                                  @foreach($monall as $mon)
                                  <li class="list-group-item mon" value="{{$mon->TenMon}}" id="<?php echo slug("$mon->TenMon"); ?>">{{$mon->TenMon}}</li>
                                  @endforeach
                                </ul>
                              </div>
                              <div class="form-group">
                                <label>Phòng</label>
                                <input type="text" id="phongInput" class="form-control phong" autocomplete="off" name="phong">
                                <ul class="list-group" id="phongList">
                                  <li class="list-group-item phong" value="B401">B401</li>
                                  <li class="list-group-item phong" value="B301">B301</li>
                                  <li class="list-group-item phong" value="B209">B209</li>
                                </ul>
                              </div>
                              <div class="form-group">
                                <label>Thứ</label>
  ...
  <script>
    function to_slug(str) {
          ...
          function myFunction() {
            var x = document.getElementById("abc").textContent;
            alert(x);
          }
          $(document).ready(function() {
            $("#adc li").on("click", function() {
              myFunction();
            });

            $(".mon").on({mouseenter:function() {
            // $("#monInput").focusout(function() {
            //   $("#monList").css("visibility", "hidden");
            // });
            $("#monList").css("visibility", "visible");
            $("#monList li").on("click", function() {
              var data = $(this).attr('value');
              $("#monInput").val(data);
              $("#monList").css("visibility", "hidden");
            });
            $("#monInput").on("keyup", function() {
              var value = $(this).val().toLowerCase();
              $("#monList li").filter(function() {
            ...
            $(".phong").on("mouseenter", function() {
            // $("#phongInput").focusout(function() {
            //   $("#phongList").css("visibility", "hidden");
            // });
            $("#phongList li").on("click", function() {
              var data = $(this).attr('value');
              $("#phongInput").val(data);
              $("#phongList").css("visibility", "hidden");
            });
            $("#phongList").css("visibility", "visible");
            $("#phongInput").on("keyup", function() {
              var value = $(this).val().toLowerCase();
              $("#phongList li").filter(function() {
                $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                // $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
              });
            });
          });
            $(".phong").on("mouseleave", function() {
              $("#phongList").css("visibility", "hidden");
            });
          });
        </script>
