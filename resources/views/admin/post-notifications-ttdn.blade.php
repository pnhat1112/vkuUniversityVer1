				...
				<div class="row">
					<div class="col-md-12">
						<div class="card card-transparent">
							...
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="update-notice/{{$edit->id}}" enctype="multipart/form-data">
										...
										<h4>Nội dung:</h4>
										<textarea id="mytextarea" name="mytextarea" style="height: 500px;">{{$edit->content}}</textarea></br>
							...
							<div class="card-body">
								<div class="col-md-10 ml-auto mr-auto">
									<form method="post" action="upload-notifications-ttdn" enctype="multipart/form-data">
										{{csrf_field()}}
										@if ($message = Session::get('success'))
										<div class="alert alert-success">
											<strong>{{ $message }}</strong>
