...
<head>
	...
	<title>Admin VKU Dashboard</title>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Xin chào {{Auth::user()->name}}!</h5>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-7">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">Tất cả môn học</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<table class="table">
											<thead>
												<tr>
													<th scope="col">ID Môn</th>
						...
						<div class="col-md-5">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">Tất cả lớp học</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<table class="table">
											<thead>
												<tr>
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/back-end/admin/assets/img/flags/id.png')}}" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/back-end/admin/assets/img/flags/au.png')}}" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/back-end/admin/assets/img/flags/ru.png')}}" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{('public/back-end/admin/assets/img/flags/cn.png')}}" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{('public/back-end/admin/assets/img/flags/br.png')}}" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="{{asset('public/back-end/admin/assets/img/logoproduct.svg')}}" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="{{asset('public/back-end/admin/assets/img/logoproduct3.svg')}}" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/back-end/admin/assets/img/jm_denis.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/back-end/admin/assets/img/chadengle.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/back-end/admin/assets/img/talha.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/back-end/admin/assets/img/mlane.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{('public/back-end/admin/assets/img/jm_denis.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
												<div class="username">Jimmy Denis</div>
												<div class="status">Graphic Designer</div>
