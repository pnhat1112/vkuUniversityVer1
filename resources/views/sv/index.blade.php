...
<body>
	<div class="wrapper">
		...
		<div class="main-panel" style="padding: 0px 30px 0px 30px;">
            ...
            <?php } ?>
            <div class="title" style="width: 100%; height: 50px; margin-top: 20px; border-radius: 10px; background: #3CB371">
						<h2 class="" style="padding: 10px 0px 0px 20px; color: #f2f2f2">Thông tin môn học:</h2>
						</div>
            <?php if(isset($svtkb)){ ?>
            <table class="table table-striped table-dark">
              <thead>
